...
let personalityTexts = {
    "Explorer": "As an Explorer, you are driven by a thirst for discovery and adventure.\nYou thrive in new environments and are always on the lookout for the unknown,\nready to traverse the unbeaten path.",
    "Strategist": "You, the Strategist, excel in planning and efficiency.\nWith a keen analytical mind,\nyou approach problems methodically,\nthinking several steps ahead and leading others through complex scenarios with ease.",
    "Visionary": "Visionaries like you are creative and inspired.\nYou see the world not only as it is but as it could be. With your innovative ideas and bold dreams,\nyou strive to make a significant impact.",
    "Guardian": "As a Guardian, your strength lies in your reliability and protective nature.\nYou are dedicated to safeguarding those around you and ensuring stability,\noften acting as the steadfast anchor in turbulent times.",
    "Allrounder": "The Allrounder is adaptable, capable of fitting into any role as needed.\nWith a flexible approach and a well-rounded skill set, you manage to excel in various fields,\nmaking you invaluable in dynamic situations."
};
...
function handleKeypress(event) {
    ...
    if (["1", "2", "3", "4"].includes(option)) {
        ...
        if (currentSection < sections.length) {
            ...
            let personalityText = personalityTexts[winningPersonality];

            container.innerHTML = "Your personality type is: " + winningPersonality + "<br>" + personalityText;
